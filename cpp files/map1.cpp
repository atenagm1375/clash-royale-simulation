...
map1::map1(::map1::QWidget *parent) : QGraphicsView(parent)
{
    ...
    kingTower = new Tower(spc::Type::BUILDING , spc::Target::All, 1.5, 4000, 100, 7, 7, px, elixirTimer);
    kingTower->setPos(520, 550);
    scene.addItem(kingTower);

    QPixmap *px1 = new QPixmap(QPixmap("sources/mainTower.png").scaled(150, 150));
    kingTowerE = new Tower(spc::Type::BUILDING , spc::Target::All, 1.5, 4000, 100, 7, 7, px1, elixirTimer);
    kingTowerE->setPos(520, 0);
    scene.addItem(kingTowerE);

    QPixmap *px2 = new QPixmap(QPixmap("sources/arenaTower.png").scaled(100, 100));
    leftArenaTower = new Tower(spc::Type::BUILDING , spc::Target::All, 1.5, 4000, 100, 7.5, 7.5, px2, elixirTimer);
    leftArenaTower->setPos(340, 500);
    scene.addItem(leftArenaTower);

    rightArenaTower = new Tower(spc::Type::BUILDING , spc::Target::All, 1.5, 4000, 100, 7.5, 7.5, px2, elixirTimer);
    ...
    leftArenaTowerE = new Tower(spc::Type::BUILDING , spc::Target::All, 1.5, 4000, 100, 7.5, 7.5, px3, elixirTimer);
    leftArenaTowerE->setPos(340, 100);
    scene.addItem(leftArenaTowerE);

    rightArenaTowerE = new Tower(spc::Type::BUILDING , spc::Target::All, 1.5, 4000, 100, 7.5, 7.5, px3, elixirTimer);
